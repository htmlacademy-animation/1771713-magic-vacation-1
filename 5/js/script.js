...
class AccentTypographyBuild {
  ...
  createElement(letter) {
    ...
    this._timeOffset = Math.floor(Math.random() * 202);
    return span;
  }
  ...
  prePareText() {
    ...
    const content = text.reduce((fragmentParent, word) => {
      ...
      wordContainer.classList.add(`animate-text__word`);
...
const animationIntroTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.intro__title`, 500, `active`, `transform`);
const animationHistoryTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.slider__item-title`, 500, `active`, `transform`);
const animationIntroDate = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.intro__date`, 500, `active`, `transform`);
const animationRulesTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.rules__title`, 500, `active`, `transform`);
const animationFooterDate = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.screen__footer-date`, 500, `active`, `transform`);
const animationPrizeTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__title`, 500, `active`, `transform`);
const animationGameTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["default"](`.game__title`, 500, `active`, `transform`);
...
/* harmony import */ var _modules_main_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/main.js */ "./source/js/modules/main.js");
// modules
...
Object(_modules_main_js__WEBPACK_IMPORTED_MODULE_9__["default"])();
